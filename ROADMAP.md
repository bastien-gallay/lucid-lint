...
| <a id="f-prose-audits"></a>[F-prose-audits](#f-prose-audits) | **Prose & Doc audits — typos + lychee.** **typos** for fast source-code spell checking (aligned with `lucid-lint` mission); **lychee** for link integrity across `docs/` and `README.md`. | 🔴 Next | Static-analysis session 2026-05-04 |
