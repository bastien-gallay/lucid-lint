...
| F25 | Docs — bilingual | FR per-rule pages (19 / 25 shipped — `structure` + `rhythm` + `lexicon` categories 100 % FR-complete) |
...
| ID | Topic | Item |
|---|---|---|
| F25 | Docs — bilingual | Per-rule FR pages + guides (19 / 25 shipped — `structure` + `rhythm` + `lexicon` categories 100 % FR-complete) |
| F34 | Docs — reading prefs | Responsive / mobile adaptation |
| F35b | Docs — reading prefs | Drop `role="radiogroup"` on reading chips (P2 a11y) |
| F35c | Docs — reading prefs | Reduced-motion colour-tint preservation (P2 a11y) |
