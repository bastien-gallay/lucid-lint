---
source_url: https://www.cdc.gov/adhd/about/index.html
title: CDC — About ADHD
upstream_type: gov_guide
polarity: good_example
languages:
- en
redistribution: public_ok
license: US federal government work — public domain in the US (CDC reuse policy at
  https://www.cdc.gov/other/agencymaterials.html states "Most material on CDC's site
  is not subject to copyright, is in the public domain, and may be freely used or
  reproduced without obtaining copyright permission."). Image/contractor exceptions
  noted; body prose unaffected.
rules_relevant:
- readability.score
...
- non-native
- general
fetched_at: '2026-04-27T19:22:32+00:00'
markdownable: 4
---
