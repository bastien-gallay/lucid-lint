---
source_url: https://simple.wikipedia.org/wiki/Main_Page
title: Simple English Wikipedia
upstream_type: corpus
polarity: good_example
languages:
- en
redistribution: public_ok
license: CC-BY-SA 4.0 (text) + GFDL — share-alike applies to derivative bundles.
rules_relevant:
- readability.score
...
Search the 280,727 articles in the Simple English Wikipedia
...
White wine is a wine made without maceration. This means the grape juice does not stay in contact with the skins, seeds, or pulp for a long time. The colour can be straw-yellow, yellow-green, or yellow-gold. Alcoholic fermentation of the clear pulp of grapes produces it. These grapes feature skins of any colour. There are many kinds of white wine. This is because there are many types of grapes, different ways of winemaking, and different amounts of leftover sugar (sweetness). Most white wine comes from "white" grapes, which are actually green or yellow. Examples include Chardonnay, Sauvignon blanc, and Riesling.
