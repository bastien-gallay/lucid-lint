...
title: Dracula — epistolary italic spans (excerpt)
upstream_type: corpus
polarity: bad_example
languages:
- en
redistribution: public_ok
license: Public domain in the US (Bram Stoker, Dracula, 1897); Project Gutenberg ebook 345, excerpt.
rules_relevant:
