...
title: NIMH — ADHD topic page
upstream_type: gov_guide
polarity: mixed_unaligned
languages:
- en
redistribution: public_ok
license: US federal government work — public domain in the US (NIMH copyright policy
  at https://www.nimh.nih.gov/site-info/policies states "Most NIMH information is
  in the public domain. You may copy and reuse it without permission.").
rules_relevant:
