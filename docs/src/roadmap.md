...
| **v0.2.x** | 🚧 **In progress** | No | FR translations ([F25](#f25) ✅ closed 2026-05-01), responsive ([F-docs-responsive](#f-docs-responsive)), [F-rule-mention-linking](#f-rule-mention-linking) rule-mention linking, [F84](#f84) part 2, [F-project-scoring-rollup](#f-project-scoring-rollup) project roll-up |
...
| [F-redundant-intensifier-bullet-fix](#f-redundant-intensifier-bullet-fix) | Rules refinement | ☐ | v0.2.x | `lexicon.redundant-intensifier` parser miss in bullet / `**strong**` spans (verification slice for [F129](#f129)) |
...
|---|---|---|---|---|---|
| Rules (refinement) | 3 ([F22](#f22) follow-up, [F-weasel-words-severity-tiering](#f-weasel-words-severity-tiering), [F-redundant-intensifier-bullet-fix](#f-redundant-intensifier-bullet-fix)) | 2 ([F10](#f10), [F22](#f22)) | — | [F1](#f1), [F13](#f13), [F-excessive-nominalization-suffix-refine](#f-excessive-nominalization-suffix-refine) | [F2](#f2), [F3](#f3) |
...
| Architecture / scoring | 4 ([F-project-scoring-rollup](#f-project-scoring-rollup), [F139](#f139), [F143](#f143), [F-roadmap-slug-ids](#f-roadmap-slug-ids)) | 1 ([F129](#f129)) | [F38](#f38), [F41](#f41) | [F-per-family-subscores](#f-per-family-subscores), [F38](#f38), [F-score-letter-grade](#f-score-letter-grade), [F-score-traffic-light](#f-score-traffic-light) | [F41](#f41) |
| Docs site (bilingual / content / theming / reading) | 2 ([F-rule-mention-linking](#f-rule-mention-linking), [F-docs-responsive](#f-docs-responsive)) | — | — | [F-docs-final-polish](#f-docs-final-polish), [F43](#f43), [F44](#f44), [F73](#f73), [F-lucid-stance-unify](#f-lucid-stance-unify), [F90](#f90)/[F91](#f91) | — |
| Docs.rs polish | — | 4 ([F133](#f133)–[F136](#f136)) | — | — | — |
| Example-text fixtures | 1 ([F84](#f84) part 2) | — | [F85](#f85), [F86](#f86) | [F-text-source-adapters](#f-text-source-adapters), [F-text-before-after-refine](#f-text-before-after-refine), [F-texts-yaml-url-maintenance](#f-texts-yaml-url-maintenance) | [F86](#f86) |
| Performance / hygiene | — | — | — | [F97](#f97) | — |
| Adoption channels | 1 ([F-vale-style-pack](#f-vale-style-pack)) | 2 ([F114](#f114), [F124](#f124)) | — | [F-falc-readiness-guide](#f-falc-readiness-guide), [F-mdbook-lint-coexistence](#f-mdbook-lint-coexistence), [F-pre-commit-hook-listing](#f-pre-commit-hook-listing), [F125](#f125) | [F122](#f122) (WASM playground) |
| Suppression / config | 1 ([F-severity-floor-flag](#f-severity-floor-flag)) | — | — | [F-suppression-reason-field](#f-suppression-reason-field), [F-suppression-disable-file](#f-suppression-disable-file), [F97](#f97) | — |
...
| Developer experience | — | [F-fix-mode](#f-fix-mode) (narrow `--fix`) | LSP server | [F138](#f138) (`--compare`), [F-explain-fancy-rendering](#f-explain-fancy-rendering) | [F12](#f12) |
...
| [F-rule-mention-linking](#f-rule-mention-linking) | Docs — content | Rule-mention linking audit + coverage test ([F44](#f44)) |
...
| ID | Item | Priority | Origin |
|---|---|---|---|
| <a id="f14"></a>[F14](#f14) | ✅ Hybrid scoring model shipped in v0.2 (global score + per-category sub-scores + diagnostics). `X/max` arbitrary-max at both levels, 5 fixed categories (Structure · Rhythm · Lexicon · Syntax · Readability), composition = weighted sum × density-normalization × per-category cap, `weight` field added to `Diagnostic`, `--min-score=N` CLI flag. See [`docs/src/guide/scoring.md`](./guide/scoring.md). Letter-grade / traffic-light / reading-time decorations deferred ([F-score-letter-grade](#f-score-letter-grade)–[F41](#f41)). | — | Architecture decision discussion |
| [F-project-scoring-rollup](#f-project-scoring-rollup) | 🚧 Document-level scoring shipped in v0.2 (multi-path runs are aggregated as one document). Project-level roll-up (per-file breakdown + project summary) still open. Section-level deferred → [F38](#f38). | 🔴 Next | Linked to [F14](#f14) |
...
| <a id="f38"></a>[F38](#f38) | Section-level granularity for scoring (deferred from [F-project-scoring-rollup](#f-project-scoring-rollup)) — per-heading sub-scores once document + project are proven in the wild. | 🟡 Later | [F14](#f14) `brainstorm/20260420-score-semantics.md` |
