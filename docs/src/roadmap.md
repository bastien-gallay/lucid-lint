...
| **v0.2.x** | 🚧 **In progress** | No | FR translations (F25 — per-rule pages 25/25 ✅, guides pending), responsive (F34), P2 a11y (F35b — F35c closed 2026-05-01 as audit false-positive), F84 part 2, perf (F102/F103 — F93/F94 refuted by profile 2026-04-25), hygiene (F95/F96), F15 project roll-up, adoption channels (F110/F111/F112) |
...
| F25 | Docs — bilingual | FR per-rule pages 25 / 25 ✅; FR guide translations 2 / 8 (slice A: installation + quick-start, 2026-05-01) |
