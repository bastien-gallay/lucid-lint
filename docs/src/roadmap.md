...
default-on. Each rule ships in v0.2.x as `Experimental` via the [F-experimental-rule-status](#f-experimental-rule-status)
...
| v0.2.0 | ✅ Released 2026-04-22 | Yes (rule-id harmonisation) | Hybrid scoring ([F14](#f14)), SARIF ([F32](#f32)), condition tags ([F71](#f71)/[F72](#f72)), 8 new rules (25 total), [F-readability-formulas-extra](#f-readability-formulas-extra) EN/FR auto-formula |
...
| **v0.2.x** | 🚧 **In progress** | No | FR translations ([F25](#f25) ✅ closed 2026-05-01), responsive ([F-docs-responsive](#f-docs-responsive)), [F-rule-mention-linking](#f-rule-mention-linking) rule-mention linking, [F-example-fixtures-part2](#f-example-fixtures-part2) part 2, [F-project-scoring-rollup](#f-project-scoring-rollup) project roll-up |
| **v0.3** | ☐ Scoped | **Yes** | [F22](#f22) v0.3 slice, [F-readability-formulas-extra](#f-readability-formulas-extra) remainder, 5 condition-tag rules ([F46](#f46)/[F49](#f49)/[F51](#f51)/[F53](#f53)/[F57](#f57)) |
| v0.4 | ☐ Horizon | Varies | LLM plugin ([F-llm-plugin](#f-llm-plugin)), alternative formats ([F-asciidoc-support](#f-asciidoc-support)–[F-pandoc-companion](#f-pandoc-companion)), feedback-driven items |
...
| <a id="f-example-fixtures-part2"></a>[F-example-fixtures-part2](#f-example-fixtures-part2) | Example fixtures | 🚧 | v0.2.x | Part 2 — redistributable replacements (3/N closed 2026-05-01) |
| [F-experimental-rule-status](#f-experimental-rule-status) | Architecture | ☐ | v0.2.x | Experimental rule status substrate — gates the v0.3 cohort, opens dogfood window |
...
| [F-weasel-words-severity-tiering](#f-weasel-words-severity-tiering) | Rules refinement | ☐ | v0.2.x | Severity tiering for `lexicon.weasel-words` (quantifier `info`, hedge `warning`) — unblocks the audit-and-PR play |
| [F-redundant-intensifier-bullet-fix](#f-redundant-intensifier-bullet-fix) | Rules refinement | ☐ | v0.2.x | `lexicon.redundant-intensifier` parser miss in bullet / `**strong**` spans (verification slice for [F-tight-list-paragraphs](#f-tight-list-paragraphs)) |
| [F-severity-floor-flag](#f-severity-floor-flag) | Suppression / config | ☐ | v0.2.x | `--severity-floor=warning` CLI flag — narrow-audit shape for external PRs |
...
| [F-repo-discoverability-polish](#f-repo-discoverability-polish) | Adoption channels | ☐ | v0.2.x | README badge row (crates.io / docs / CI / license) + GitHub social preview image (1280×640) — first-impression surfaces for crates.io and link unfurls |
| [F-report-quick-wins](#f-report-quick-wins) | Reporting / DX | ☐ | v0.2.x | TTY quick-wins block under the diagnostic list — acronym whitelist hint + single-rule hot-spot hint; non-breaking, additive |
| <a id="f-project-scoring-rollup"></a>[F-project-scoring-rollup](#f-project-scoring-rollup) | Architecture | ☐ | v0.2.x | Project-level scoring roll-up (per-file + summary) |
| <a id="f-rule-mention-linking"></a>[F-rule-mention-linking](#f-rule-mention-linking) | Docs — content | ☐ | v0.2.x | Rule-mention linking pass across guide-prose pages |
| <a id="f-docs-responsive"></a>[F-docs-responsive](#f-docs-responsive) | Docs — reading prefs | ☐ | v0.2.x | Responsive / mobile adaptation |
...
|---|---|---|---|---|---|
| Rules (refinement) | 3 ([F22](#f22) follow-up, [F-weasel-words-severity-tiering](#f-weasel-words-severity-tiering), [F-redundant-intensifier-bullet-fix](#f-redundant-intensifier-bullet-fix)) | 2 ([F-readability-formulas-extra](#f-readability-formulas-extra), [F22](#f22)) | — | [F-low-diversity-stoplist](#f-low-diversity-stoplist), [F-missing-connectors](#f-missing-connectors), [F-excessive-nominalization-suffix-refine](#f-excessive-nominalization-suffix-refine) | [F-sentence-diversity-density](#f-sentence-diversity-density), [F-comma-density-relative](#f-comma-density-relative) |
| New rules | — | 5 ([F46](#f46), [F49](#f49), [F51](#f51), [F53](#f53), [F57](#f57)) | [F-rhythm-forward-reference-heavy](#f-rhythm-forward-reference-heavy)–[F-syntax-address-inconsistency](#f-syntax-address-inconsistency), [F-lexicon-vocabulary-rarity](#f-lexicon-vocabulary-rarity) | [F58](#f58), [F-rhythm-pronoun-density](#f-rhythm-pronoun-density), [F-rhythm-topic-shift-cluster](#f-rhythm-topic-shift-cluster), [F-lexicon-falc-idiom](#f-lexicon-falc-idiom) | [F-paragraph-landmark-density](#f-paragraph-landmark-density), [F-lede-buried](#f-lede-buried) |
| Architecture / scoring | 4 ([F-project-scoring-rollup](#f-project-scoring-rollup), [F-experimental-rule-status](#f-experimental-rule-status), [F143](#f143), [F-roadmap-slug-ids](#f-roadmap-slug-ids)) | 1 ([F-tight-list-paragraphs](#f-tight-list-paragraphs)) | [F-section-scoring](#f-section-scoring), [F-reading-time-score](#f-reading-time-score) | [F-adversarial-review](#f-adversarial-review), [F-per-family-subscores](#f-per-family-subscores), [F-section-scoring](#f-section-scoring), [F-score-letter-grade](#f-score-letter-grade), [F-score-traffic-light](#f-score-traffic-light) | [F-reading-time-score](#f-reading-time-score) |
| Docs site (bilingual / content / theming / reading) | 2 ([F-rule-mention-linking](#f-rule-mention-linking), [F-docs-responsive](#f-docs-responsive)) | — | — | [F-docs-final-polish](#f-docs-final-polish), [F43](#f43), [F-rule-mention-coverage-test](#f-rule-mention-coverage-test), [F73](#f73), [F-lucid-stance-unify](#f-lucid-stance-unify), [F-summary-per-locale](#f-summary-per-locale)/[F-multi-book-mdbook](#f-multi-book-mdbook) | — |
| Docs.rs polish | — | 4 ([F-docsrs-metadata](#f-docsrs-metadata)–[F-public-api-audit](#f-public-api-audit)) | — | — | — |
| Example-text fixtures | 1 ([F-example-fixtures-part2](#f-example-fixtures-part2) part 2) | — | [F-rule-fixture-coverage-map](#f-rule-fixture-coverage-map), [F-reference-auto-discovery](#f-reference-auto-discovery) | [F-text-source-adapters](#f-text-source-adapters), [F-text-before-after-refine](#f-text-before-after-refine), [F-texts-yaml-url-maintenance](#f-texts-yaml-url-maintenance) | [F-reference-auto-discovery](#f-reference-auto-discovery) |
| Performance / hygiene | — | — | — | [F-config-whitelist-normalize](#f-config-whitelist-normalize) | — |
| Adoption channels | 2 ([F-vale-style-pack](#f-vale-style-pack), [F-repo-discoverability-polish](#f-repo-discoverability-polish)) | 2 ([F-github-action](#f-github-action), [F-npm-wrapper](#f-npm-wrapper)) | — | [F-falc-readiness-guide](#f-falc-readiness-guide), [F-mdbook-lint-coexistence](#f-mdbook-lint-coexistence), [F-pre-commit-hook-listing](#f-pre-commit-hook-listing), [F-homebrew-tap](#f-homebrew-tap) | [F-wasm-playground](#f-wasm-playground) (WASM playground) |
| Suppression / config | 1 ([F-severity-floor-flag](#f-severity-floor-flag)) | — | — | [F-suppression-reason-field](#f-suppression-reason-field), [F-suppression-disable-file](#f-suppression-disable-file), [F-config-whitelist-normalize](#f-config-whitelist-normalize) | — |
| Formats | — | — | [F-asciidoc-support](#f-asciidoc-support)–[F-pandoc-companion](#f-pandoc-companion) (single pick) | [F-asciidoc-support](#f-asciidoc-support)–[F-pandoc-companion](#f-pandoc-companion) | — |
| Ecosystem interop | — | [F-interop-suppression](#f-interop-suppression) | — | [F-interop-suppression](#f-interop-suppression) | — |
| Plugins / NLP / LLM | — | [F-nlp-plugin](#f-nlp-plugin) (Should) | [F-llm-plugin](#f-llm-plugin), [F-nlp-plugin](#f-nlp-plugin) | [F-nlp-plugin](#f-nlp-plugin) | [F-llm-plugin](#f-llm-plugin) |
| Developer experience | — | [F-fix-mode](#f-fix-mode) (narrow `--fix`) | LSP server | [F-diff-mode](#f-diff-mode) (`--compare`), [F-explain-fancy-rendering](#f-explain-fancy-rendering) | [F-score-evolution-dashboard](#f-score-evolution-dashboard) |
| Reporting / DX | 1 ([F-report-quick-wins](#f-report-quick-wins)) | — | — | — | — |
| Research track | — | — | [F-rule-discovery-corpus](#f-rule-discovery-corpus), [F-external-feedback-top3](#f-external-feedback-top3) (user feedback) | — | [F-paragraph-landmark-density](#f-paragraph-landmark-density), [F-lede-buried](#f-lede-buried), [F-rule-discovery-corpus](#f-rule-discovery-corpus) |
...
- **v0.3** opens only when the v0.2.x Must queue is empty and at least
  ...
  held — non-breaking items that would otherwise fit 0.3 (e.g. [F-score-letter-grade](#f-score-letter-grade)
...
| Bet | Unlock signal |
|---|---|
| [F-llm-plugin](#f-llm-plugin) — `lucid-lint-llm` plugin | ≥ 2 concrete LLM-as-Judge rules designed on paper; deterministic-core base stable enough that non-determinism is a clear opt-in |
| [F-asciidoc-support](#f-asciidoc-support) / [F-html-support](#f-html-support) / [F-docx-support](#f-docx-support) / [F-pandoc-companion](#f-pandoc-companion) — alternative formats (AsciiDoc / HTML / .docx / pandoc bridge) | External user requests; pick the single format with most pull and ship it alone, not the set |
| [F-rule-fixture-coverage-map](#f-rule-fixture-coverage-map) + [F-reference-auto-discovery](#f-reference-auto-discovery) — fixture coverage maps + auto-discovery | Referential has stabilised ([F-example-fixtures-part2](#f-example-fixtures-part2) part 2 done) and rule set stops churning |
| [F-lexicon-vocabulary-rarity](#f-lexicon-vocabulary-rarity) — vocabulary-rarity | Lexique.org + COCA frequency lexicons built and licence-cleared |
| [F-rhythm-forward-reference-heavy](#f-rhythm-forward-reference-heavy) – [F-syntax-address-inconsistency](#f-syntax-address-inconsistency) — remaining condition-tag rules | [F46](#f46) / [F49](#f49) / [F51](#f51) / [F53](#f53) / [F57](#f57) validated in the wild at 0.3 |
| [F-section-scoring](#f-section-scoring) — section-level scoring | Document + project level proven; users ask "which H2 is the problem?" |
| [F-reading-time-score](#f-reading-time-score) — reading-time unit | Validated heuristic exists; companion metrics (comfort, fatigue, understandability) defined |
| [F-score-evolution-dashboard](#f-score-evolution-dashboard) — score-evolution dashboard | CI users explicitly ask for trend view (not delta — delta is [F-diff-mode](#f-diff-mode) / `--compare`) |
| [F-interop-suppression](#f-interop-suppression) — interop suppression (if not shipped in 0.3) | A second rule joins `deeply-nested-lists` as a markdownlint overlap |
| [F-rule-discovery-corpus](#f-rule-discovery-corpus) — rule-discovery corpus mining | Student / intern resource available; separate research track |
| LSP server | Editor demand visible (Cursor / VSCode issues); would change the deployment story |
| [F-lede-buried](#f-lede-buried) / [F-paragraph-landmark-density](#f-paragraph-landmark-density) — research-track rules | Only if someone codes them for fun |
| <a id="f-external-feedback-top3"></a>**[F-external-feedback-top3](#f-external-feedback-top3) — top 3 items from first-10-external-users feedback (TBD)** | 0.2.0 ships and ≥ 10 non-maintainer users exist — placeholder reserved so the horizon isn't 100 % maintainer bets (renumbered from [F98](#f98) post-collision with stream-2 cargo-mutants) |
| <a id="f-figurative-language"></a>**[F-figurative-language](#f-figurative-language) — metaphor / analogy / comparison detection (NLP or LLM plugin).** Cognitive-load grounded: figurative language costs extra inference for tired readers, aphasia, L2 readers, and is a known axis for ASD (currently out of v0.2/v0.3 scope). Belongs in `lucid-lint-nlp` ([F-nlp-plugin](#f-nlp-plugin)) or `lucid-lint-llm` ([F-llm-plugin](#f-llm-plugin)) — non-deterministic, so plugin-only per prime directive #4. Bilingual-viable concern: idiomatic FR vs EN metaphors don't map; FR + EN paths need separate corpora at proposal time. | Either NLP or LLM plugin scaffolding lands AND a dogfood / external case surfaces a missed metaphor that confused a reader |

**Deliberately off the 0.4 list:**

- [F-score-letter-grade](#f-score-letter-grade) / [F-score-traffic-light](#f-score-traffic-light) letter grade + traffic light — routed to 0.3 Should; if
  they slip they go to 0.3.x, not 0.4.
- Full [F29](#f29) numeric codes — parked until a rename actually happens.
- [F-sentence-diversity-density](#f-sentence-diversity-density), [F-comma-density-relative](#f-comma-density-relative) speculative rule refinements — stay speculative until a
  concrete dogfood case surfaces.
- [F-per-family-subscores](#f-per-family-subscores) per-family sub-scores — category sub-scores ([F14](#f14)) already ship;
...
|---|---|---|---|
| <a id="f-llm-plugin"></a>[F-llm-plugin](#f-llm-plugin) | `lucid-lint-llm` plugin (LLM-as-Judge rules) | 🟢 Speculative | Research on existing tools |
...
| <a id="f-rhythm-pronoun-density"></a>[F-rhythm-pronoun-density](#f-rhythm-pronoun-density) | `rhythm.pronoun-density` | Rhythm | `aphasia`, `general` | FALC | — |
| <a id="f-rhythm-topic-shift-cluster"></a>[F-rhythm-topic-shift-cluster](#f-rhythm-topic-shift-cluster) | `rhythm.topic-shift-cluster` | Rhythm | `adhd`, `general` | Hemingway | May merge into [F-missing-connectors](#f-missing-connectors) after corpus review |
| <a id="f-lexicon-falc-idiom"></a>[F-lexicon-falc-idiom](#f-lexicon-falc-idiom) | `lexicon.falc-idiom` | Lexicon | `aphasia`, `non-native` | IFLA, FALC | Curated bilingual idiom lexicon |
| <a id="f-lexicon-vocabulary-rarity"></a>[F-lexicon-vocabulary-rarity](#f-lexicon-vocabulary-rarity) | `lexicon.vocabulary-rarity` | Lexicon | `non-native`, `general` | — | Frequency lexicon per language (Lexique.org for FR, COCA / Google-Books for EN). Tiered weights: `common` / `context-dependent` / `expert`. LLM-built fallback only. |
| <a id="f-rhythm-forward-reference-heavy"></a>[F-rhythm-forward-reference-heavy](#f-rhythm-forward-reference-heavy) | `rhythm.forward-reference-heavy` | Rhythm | `adhd`, `general` | Working-memory load | — |
| <a id="f-lexicon-acronym-distance"></a>[F-lexicon-acronym-distance](#f-lexicon-acronym-distance) | `lexicon.acronym-distance-from-definition` | Lexicon | `adhd`, `non-native` | Memory decay | [F9](#f9) (definition-aware abbreviation) |
| <a id="f-syntax-complex-tense"></a>[F-syntax-complex-tense](#f-syntax-complex-tense) | `syntax.complex-tense` | Syntax | `non-native`, `aphasia` | FALC tense restrictions | FR morphology primary; EN lighter |
| <a id="f-syntax-impersonal-voice-heavy"></a>[F-syntax-impersonal-voice-heavy](#f-syntax-impersonal-voice-heavy) | `syntax.impersonal-voice-heavy` | Syntax | `aphasia` | FALC direct-address rule | — |
| <a id="f-syntax-address-inconsistency"></a>[F-syntax-address-inconsistency](#f-syntax-address-inconsistency) | `syntax.address-inconsistency` | Syntax | `non-native`, `general` | Register consistency | FR primary (tu / vous); EN weaker (you / one) |

### Developer experience (v0.3)

| ID | Item | Priority | Origin |
|---|---|---|---|
| <a id="f-diff-mode"></a>[F-diff-mode](#f-diff-mode) | Differential diagnostics — `--compare=<ref>` CLI mode. Runs against two revisions of the same text(s) and reports score-delta + diagnostic-delta. Pitch: CI/PR comment framing ("this PR adds 2 warnings, removes 5, net −3"), inverting alarm fatigue the way coverage tools do. CLI + JSON + SARIF-run-comparison. No dashboard (that is [F-score-evolution-dashboard](#f-score-evolution-dashboard)). | 🟡 Later | Rule-system-growth brainstorm (2026-04-20). Depends on [F14](#f14) stabilising. |
| <a id="f-explain-fancy-rendering"></a>[F-explain-fancy-rendering](#f-explain-fancy-rendering) | Fancy terminal rendering for `lucid-lint explain` — pipe the bundled markdown through `termimad` (or a custom `pulldown-cmark` + `owo-colors` walker) so headings, tables, code fences, bullets, and inline `code` render with proper typography instead of raw markdown. Ship a toned `Skin` that matches the existing warning-yellow / info-cyan palette rather than termimad's magenta defaults — the brand direction is calm, typographic, not "rich CLI". Defer past v0.2 so the `check` output polish (F?) lands first. | 🟡 Later | TTY-output critique (2026-04-22) |
...
non-Markdown input (plain text, .docx via [F-docx-support](#f-docx-support), HTML via [F-html-support](#f-html-support)) all rely on
...
renamed to [F-vale-style-pack](#f-vale-style-pack) under the slug
...
| ID | Item | Priority | Origin |
|---|---|---|---|
| <a id="f-paragraph-landmark-density"></a>[F-paragraph-landmark-density](#f-paragraph-landmark-density) | `structure.paragraph-landmark-density` — reprise-points for attention-fragile readers. Research needed to define "landmark" (bold / italic / headers / list-starts / code spans?). | 🟢 Speculative | Rule-system-growth brainstorm (2026-04-20) |
| <a id="f-lede-buried"></a>[F-lede-buried](#f-lede-buried) | `structure.lede-buried` — journalistic inverted-pyramid check. Strong candidate for a future `lucid-lint-journalism` plugin rather than core. | 🟢 Speculative | Rule-system-growth brainstorm (2026-04-20) |
| <a id="f-rule-discovery-corpus"></a>[F-rule-discovery-corpus](#f-rule-discovery-corpus) | Rule-discovery corpus project — mine writer-heavy git histories for patterns that authors repeatedly rewrite. Source of evidence-grounded rule proposals. Intern / student project scale. | 🟢 Speculative | Rule-system-growth brainstorm (2026-04-20) |
...
| <a id="f-fail-on-warning-bool"></a>[F-fail-on-warning-bool](#f-fail-on-warning-bool) | `--fail-on-warning` accepts optional boolean; hidden mirror `--no-fail-on-warning`. `--min-score` now testable in isolation on documents with warnings. |

### v0.2.1 — ✅ Released 2026-04-23

Localhost 404.html rendering fix ([F-example-fixtures-part2](#f-example-fixtures-part2) part 1), per-rule TOML override
...
| [F-docs-responsive](#f-docs-responsive) | Docs — reading prefs | Responsive / mobile adaptation |
| <a id="f35b"></a>[F35b](#f35b) | Docs — reading prefs | Drop `role="radiogroup"` on reading chips (P2 a11y) |
| [F-example-fixtures-part2](#f-example-fixtures-part2) part 2 | Example-text fixtures | Redistributable replacements for load-bearing slots |
| [F-vale-style-pack](#f-vale-style-pack) | Adoption channels | Vale style pack (subset of rules → `vale-cli/packages` topic) |
| [F-experimental-rule-status](#f-experimental-rule-status) | Architecture | Experimental rule status substrate — gates v0.3 cohort, opens dogfood window |
| [F143](#f143) | Architecture | Inline AST layer over pulldown-cmark — substrate for [F49](#f49) (cohort lead) |
| [F-weasel-words-severity-tiering](#f-weasel-words-severity-tiering) | Rules refinement | Severity tiering for `lexicon.weasel-words` (quantifier `info`, hedge `warning`) — unblocks the audit-and-PR play |
| [F-redundant-intensifier-bullet-fix](#f-redundant-intensifier-bullet-fix) | Rules refinement | Fix `lexicon.redundant-intensifier` parser miss in bullet / `**strong**` spans — unblocks the audit-and-PR play |
| [F-severity-floor-flag](#f-severity-floor-flag) | Suppression / config | `--severity-floor` CLI flag — unblocks the audit-and-PR play narrow-audit shape |
| [F-report-quick-wins](#f-report-quick-wins) | Reporting / DX | TTY quick-wins block under the diagnostic list — acronym whitelist hint + single-rule hot-spot hint |

#### Should — ships as the next patch absorbs it

| ID | Topic | Item |
|---|---|---|
| [F-project-scoring-rollup](#f-project-scoring-rollup) | Architecture | Project-level scoring roll-up (per-file + summary) |
| — | Suppression / config | Per-rule TOML plumbing, rule-by-rule as each `Config` gains `Deserialize` |
| <a id="f-suppression-reason-field"></a>[F-suppression-reason-field](#f-suppression-reason-field) | Suppression / config | `reason="..."` field on suppression directives |
| [F-rule-mention-linking](#f-rule-mention-linking) | Docs — content | Rule-mention linking audit + coverage test ([F-rule-mention-coverage-test](#f-rule-mention-coverage-test)) |
| [F-github-action](#f-github-action) | Adoption channels | GitHub Action published to Marketplace (depends on stable SARIF output) |
| [F-falc-readiness-guide](#f-falc-readiness-guide) | Adoption channels | FALC-readiness guide page citing Inclusion Europe standards |
...
[F-excessive-nominalization-suffix-refine](#f-excessive-nominalization-suffix-refine) (nominalization suffix refine), [F43](#f43) (RULES.md drift cleanup), [F73](#f73)
(font-leak CI gate), [F-docs-final-polish](#f-docs-final-polish) (final polish pass), [F-explain-fancy-rendering](#f-explain-fancy-rendering) (fancy `explain`
rendering), [F-suppression-disable-file](#f-suppression-disable-file) (`disable-file`), [F-text-source-adapters](#f-text-source-adapters) / [F-text-before-after-refine](#f-text-before-after-refine) / [F-texts-yaml-url-maintenance](#f-texts-yaml-url-maintenance) (fixture hygiene),
**[F-mdbook-lint-coexistence](#f-mdbook-lint-coexistence)** (mdbook-lint coexistence guide),
**[F-pre-commit-hook-listing](#f-pre-commit-hook-listing)** (pre-commit hook listing once `--check` mode stabilises).

#### Won't (pushed to 0.3)

[F-score-letter-grade](#f-score-letter-grade) letter grade, [F-score-traffic-light](#f-score-traffic-light) traffic light, [F-per-family-subscores](#f-per-family-subscores) per-family sub-scores, [F-lucid-stance-unify](#f-lucid-stance-unify)
`.lucid-stance` unify, [F-fix-mode](#f-fix-mode) `--fix` mode (narrow).
...
- **[F-readability-formulas-extra](#f-readability-formulas-extra) remainder** — SMOG, Dale-Chall, Scolarius,
  `--readability-verbose`.
...
| ID | Item | Priority | Origin |
|---|---|---|---|
| <a id="f14"></a>[F14](#f14) | ✅ Hybrid scoring model shipped in v0.2 (global score + per-category sub-scores + diagnostics). `X/max` arbitrary-max at both levels, 5 fixed categories (Structure · Rhythm · Lexicon · Syntax · Readability), composition = weighted sum × density-normalization × per-category cap, `weight` field added to `Diagnostic`, `--min-score=N` CLI flag. See [`docs/src/guide/scoring.md`](./guide/scoring.md). Letter-grade / traffic-light / reading-time decorations deferred ([F-score-letter-grade](#f-score-letter-grade)–[F-reading-time-score](#f-reading-time-score)). | — | Architecture decision discussion |
| [F-project-scoring-rollup](#f-project-scoring-rollup) | 🚧 Document-level scoring shipped in v0.2 (multi-path runs are aggregated as one document). Project-level roll-up (per-file breakdown + project summary) still open. Section-level deferred → [F-section-scoring](#f-section-scoring). | 🔴 Next | Linked to [F14](#f14) |
| <a id="f-per-family-subscores"></a>[F-per-family-subscores](#f-per-family-subscores) | Per-family sub-scores | 🟡 Later | Linked to [F14](#f14) |
...
| <a id="f-section-scoring"></a>[F-section-scoring](#f-section-scoring) | Section-level granularity for scoring (deferred from [F-project-scoring-rollup](#f-project-scoring-rollup)) — per-heading sub-scores once document + project are proven in the wild. | 🟡 Later | [F14](#f14) `brainstorm/20260420-score-semantics.md` |
| <a id="f-score-letter-grade"></a>[F-score-letter-grade](#f-score-letter-grade) | Letter-grade decoration (A–F) on the `X/max` score — promote when user feedback shows the numbers feel noisy or hard to compare across docs. | 🟡 Later | [F14](#f14) `brainstorm/20260420-score-semantics.md` |
| <a id="f-score-traffic-light"></a>[F-score-traffic-light](#f-score-traffic-light) | Traffic-light (🔴🟡🟢) + pass/fail margin in the TTY output — promote when CI users ask for a stronger glance signal than the number alone. | 🟡 Later | [F14](#f14) `brainstorm/20260420-score-semantics.md` |
| <a id="f-reading-time-score"></a>[F-reading-time-score](#f-reading-time-score) | Reading-time-seconds as an alternative score unit — ties score to concrete user outcome. Requires validated heuristic + companion metrics (comfort, fatigue, understandability) so the time unit doesn't monopolize the read. | 🟢 Speculative | [F14](#f14) `brainstorm/20260420-score-semantics.md` |
...
| <a id="f-mixed-script-fixtures"></a>[F-mixed-script-fixtures](#f-mixed-script-fixtures) | **Mixed-script test fixtures.** Pin behaviour on EN + CJK and LTR + RTL prose mixed within one paragraph. `unicode_words()` should handle the boundaries correctly (UAX-29), but no regression test exists. Filed as Speculative — no known bug, just a coverage gap. Open if a real-world bilingual corpus surfaces edge cases. | 🟢 Speculative | 2026-04-25 encoding survey |
...
| [F-readability-formulas-extra](#f-readability-formulas-extra) | 🚧 Must-ship slice shipped in v0.2 — `readability.score` auto-selects the formula by detected language: Flesch-Kincaid for EN (kept), Kandel & Moles (1958) for FR. Kandel-Moles ease scores are converted to a grade-equivalent so per-profile `max_grade_level` stays comparable across languages. Unknown language → Flesch-Kincaid. See [`docs/src/rules/readability-score.md`](./rules/readability-score.md). Still open: Gunning Fog / SMOG / Dale-Chall (EN), Scolarius / Flesch-Kandel (FR), `--readability-verbose` multi-formula reports, per-file override (covered by [F11](#f11)). | 🟡 Later | Rule 11 simplified in v0.1; scope expanded in rule-system-growth brainstorm (2026-04-20) |
| <a id="f11"></a>[F11](#f11) | ✅ Shipped in v0.2 — `--readability-formula {auto,flesch-kincaid,kandel-moles}` CLI flag + `FormulaChoice` enum on `readability_score::Config` + `Engine::with_readability_formula(choice)`. `auto` (default) keeps [F-readability-formulas-extra](#f-readability-formulas-extra) per-language selection; `flesch-kincaid` / `kandel-moles` pin a formula for cross-document comparison. TOML config wiring is tracked separately as [F77](#f77). | 🟡 Later | Rule 11 |
| <a id="f-missing-connectors"></a>[F-missing-connectors](#f-missing-connectors) | `missing-connectors` rule (15b not shipped in v0.1) | 🟡 Later | Rule 15 decomposition |
| <a id="f-low-diversity-stoplist"></a>[F-low-diversity-stoplist](#f-low-diversity-stoplist) | Custom stoplist parameter for `lexicon.low-lexical-diversity` | 🟡 Later | Rule 5 |
| <a id="f-sentence-diversity-density"></a>[F-sentence-diversity-density](#f-sentence-diversity-density) | Sentence-level low-lexical-diversity density | 🟢 Speculative | Rule 5 |
| <a id="f-comma-density-relative"></a>[F-comma-density-relative](#f-comma-density-relative) | Comma density metric (relative) for `structure.excessive-commas` | 🟢 Speculative | Rule 3a |
...
| <a id="f-config-whitelist-normalize"></a>[F-config-whitelist-normalize](#f-config-whitelist-normalize) | **Config whitelist normalization at load time.** `src/config.rs` — normalize (trim, case-fold per rule needs) on load instead of per invocation; catches user typos early. Small win; fits a v0.3 config-plumbing pass rather than a 0.2.x patch. | 🟡 Later | 2026-04-24 code review (stream-2 #6) |
...
|---|---|---|---|---|---|
| <a id="f48"></a>[F48](#f48) | ✅ `lexicon.all-caps-shouting` shipped in v0.2 — see [`docs/src/rules/all-caps-shouting.md`](./rules/all-caps-shouting.md) | Lexicon | `a11y-markup`, `dyslexia`, `general` | WCAG 3.1.5, BDA Dyslexia Style Guide | — |
| <a id="f55"></a>[F55](#f55) | ✅ `syntax.nested-negation` shipped in v0.2 — see [`docs/src/rules/nested-negation.md`](./rules/nested-negation.md) | Syntax | `aphasia`, `adhd`, `general` | FALC, CDC Clear Communication Index | — |
| <a id="f56"></a>[F56](#f56) | ✅ `syntax.conditional-stacking` shipped in v0.2 — see [`docs/src/rules/conditional-stacking.md`](./rules/conditional-stacking.md) | Syntax | `aphasia`, `adhd`, `general` | FALC, plainlanguage.gov | — |

**Should-ship v0.2 (cuttable under time pressure, in suggested cut order):**

| ID | Rule | Category | Tags | Grounding | Priority |
|---|---|---|---|---|---|
| <a id="f62"></a>[F62](#f62) | ✅ `lexicon.redundant-intensifier` shipped in v0.2 — see [`docs/src/rules/redundant-intensifier.md`](./rules/redundant-intensifier.md) | Lexicon | `general` | Plain-language guides | 🟡 Later |
| <a id="f52"></a>[F52](#f52) | ✅ `structure.mixed-numeric-format` shipped in v0.2 — see [`docs/src/rules/mixed-numeric-format.md`](./rules/mixed-numeric-format.md) | Structure | `dyscalculia`, `general` | CDC Clear Communication Index | 🟡 Later |
| <a id="f50"></a>[F50](#f50) | ✅ `structure.line-length-wide` shipped in v0.2 — see [`docs/src/rules/line-length-wide.md`](./rules/line-length-wide.md) | Structure | `dyslexia`, `general` | WCAG 1.4.8 (AAA) | 🟡 Later |
| <a id="f47"></a>[F47](#f47) | ✅ `lexicon.consonant-cluster` shipped in v0.2 — see [`docs/src/rules/consonant-cluster.md`](./rules/consonant-cluster.md) | Lexicon | `dyslexia`, `general` | BDA Dyslexia Style Guide | 🟡 Later |
| <a id="f54"></a>[F54](#f54) | ✅ `syntax.dense-punctuation-burst` shipped in v0.2 — see [`docs/src/rules/dense-punctuation-burst.md`](./rules/dense-punctuation-burst.md) | Syntax | `general` | IFLA easy-to-read guidelines | 🟡 Later |
...
| ID | Item | Priority | Origin |
|---|---|---|---|
| <a id="f-asciidoc-support"></a>[F-asciidoc-support](#f-asciidoc-support) | Native AsciiDoc support | 🟡 Later | Format scope v0.1 |
| <a id="f-html-support"></a>[F-html-support](#f-html-support) | Native HTML support | 🟡 Later | Relevant for EAA compliance |
| <a id="f-docx-support"></a>[F-docx-support](#f-docx-support) | `.docx` support via Pandoc integration | 🟡 Later | FALC institutional target |
| <a id="f-pandoc-companion"></a>[F-pandoc-companion](#f-pandoc-companion) | Companion script `pandoc → lucid-lint` | 🟡 Later | Documented in v0.1 README |
...
| ID | Item | Priority | Origin |
|---|---|---|---|
| <a id="f-code-block-without-lang"></a>[F-code-block-without-lang](#f-code-block-without-lang) | `code-block-without-lang` rule | 🟡 Later | Rule 8 dropped from v0.1, candidate for `lucid-lint-docs` plugin |
...
| ID | Item | Priority | Origin |
|---|---|---|---|
| <a id="f-docsrs-metadata"></a>[F-docsrs-metadata](#f-docsrs-metadata) | `[package.metadata.docs.rs]` block in `Cargo.toml`. Pin the toolchain and feature set docs.rs builds with; add `rustdoc-args = ["--cfg", "docsrs"]` so any future feature-gated items can carry `#[cfg_attr(docsrs, doc(cfg(feature = "x")))]` and render the "available with feature X" badge. Cheap, lands the day a real feature flag is introduced. Renumbered from [F-tight-list-paragraphs](#f-tight-list-paragraphs) (collision with the parser tight-list fix that landed in parallel). | 🟢 Speculative (0.2.x or 0.3) | 2026-05-01 docs.rs polish discussion |
| <a id="f130"></a><a id="f-docsrs-logo"></a>[F-docsrs-logo](#f-docsrs-logo) | Logo + favicon on docs.rs via `#![doc(html_logo_url = "…")]` and `#![doc(html_favicon_url = "…")]` at crate root. Reuses an asset hosted under the repo's raw URL. Tiny visual identity win on the docs.rs landing page. Renumbered from [F130](#f130). | 🟢 Speculative (0.2.x) | 2026-05-01 docs.rs polish discussion |
| <a id="f131"></a><a id="f-doctest-entrypoints"></a>[F-doctest-entrypoints](#f-doctest-entrypoints) | One runnable doctest per major entry point (`Engine::with_profile`, `Engine::lint_str`, `Report` field access, key `Profile` variants). `///` blocks render as code samples on docs.rs *and* run under `cargo test --doc`, so they cannot rot. ~5 lines each. Lifts the API page from "list of names" to self-explanatory reference. Renumbered from [F131](#f131). | 🟡 Later (0.3) | 2026-05-01 docs.rs polish discussion |
| <a id="f132"></a><a id="f-public-api-audit"></a>[F-public-api-audit](#f-public-api-audit) | Public-API audit with `cargo public-api`: surface candidates that should carry `#[doc(hidden)]` (re-exports for macros, internal helpers leaked via `pub`) so the rustdoc index reflects the *intended* surface, not the *current* surface. Pair with a CI gate later if the surface becomes load-bearing for SemVer. Renumbered from [F132](#f132). | 🟡 Later (0.3) | 2026-05-01 docs.rs polish discussion |
...
|---|---|---|
| ✅ | Minimal inline-disable | `<!-- lucid-lint disable-next-line <rule-id> -->` for Markdown inputs, single rule id, optional reason. See [RULES.md → Suppressing diagnostics](https://github.com/bastien-gallay/lucid-lint/blob/main/RULES.md#suppressing-diagnostics). Block form, config ignores, file-level scope and required `reason=` are tracked as [F18](#f18)–[F-suppression-disable-file](#f-suppression-disable-file) below. |
