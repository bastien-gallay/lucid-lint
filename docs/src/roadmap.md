...
| **v0.2.x** | 🚧 **In progress** | No | FR translations (F25 — per-rule pages 25/25 ✅, guides 8/8 ✅ as of 2026-05-01), responsive (F34), P2 a11y (F35b — F35c closed 2026-05-01 as audit false-positive), F84 part 2, perf (F102/F103 — F93/F94 refuted by profile 2026-04-25), hygiene (F95/F96), F15 project roll-up, adoption channels (F110/F111/F112) |
...
| F25 | Docs — bilingual | FR per-rule pages 25 / 25 ✅; FR guide translations 8 / 8 ✅ (Block C complete 2026-05-01); 3 EN-only pages remain (architecture overview, design-decisions, contributing) |
...
| ID | Topic | Item |
|---|---|---|
| F25 | Docs — bilingual | Per-rule FR pages 25 / 25 ✅; FR guide translations 8 / 8 ✅ (Block C complete 2026-05-01) — only architecture / contributing pages remain |
| F34 | Docs — reading prefs | Responsive / mobile adaptation |
| F35b | Docs — reading prefs | Drop `role="radiogroup"` on reading chips (P2 a11y) |
