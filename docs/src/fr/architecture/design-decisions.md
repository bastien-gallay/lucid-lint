...
- Notes en lettres, feux tricolores, marge réussite/échec et secondes de lecture ont été coupés du design v0.2 après une analyse à partir des principes de base ([F39](../roadmap.md)–[F41](../roadmap.md) dans ROADMAP). Ils dupliquent la fonction-1 (vue d'un coup d'œil) que le nombre remplit déjà.
